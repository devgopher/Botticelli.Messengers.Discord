...
{
    private readonly BotSettingsBuilder<DiscordBotSettings> _settingsBuilder;
    private IHttpClientFactory _httpClientFactory;
    private ILogger<MessagePublisher> _logger;

    private MessagePublisherBuilder(BotSettingsBuilder<DiscordBotSettings> settingsBuilder)
    {
        _settingsBuilder = settingsBuilder;
    }

    public static MessagePublisherBuilder Instance(BotSettingsBuilder<DiscordBotSettings> settingsBuilder)
    {
